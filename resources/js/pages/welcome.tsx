...
export default function Welcome() {
    ...
    return (
        <div className="relative flex min-h-screen flex-col overflow-x-hidden bg-[#070b14] text-slate-100 selection:bg-cyan-500/30">
            ...
            {/* Top Navigation Bar */}
            <header className="sticky top-0 z-50 border-b border-slate-800/80 bg-[#070b14]/90 backdrop-blur-md transition-colors">
                <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
                    ...
                    <nav className="hidden items-center gap-6 text-xs font-semibold md:flex">
                        <Link
                            href="/choose"
                            className="font-bold text-cyan-400 transition-colors hover:underline"
                        >
                    ...
                    <div className="flex items-center gap-3">
                        <Link href="/demo-login">
                            <Button
                                size="sm"
                                variant="outline"
                                className="hidden border-cyan-500/40 bg-cyan-500/10 text-xs font-bold text-cyan-400 shadow-sm transition-all hover:bg-cyan-500/20 sm:inline-flex"
                            >
                                <Zap className="mr-1 size-3.5 animate-pulse text-cyan-400" />
            ...
            <section className="relative overflow-hidden bg-gradient-to-b from-[#0a1426] via-[#070b14] to-[#070b14] pt-8 pb-12 sm:pt-14 sm:pb-16">
                <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 items-center gap-8 lg:grid-cols-12 lg:gap-8">
                        ...
                        <div className="flex flex-col items-start text-left lg:col-span-7">
                            ...
                            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-cyan-500/30 bg-cyan-500/10 px-4 py-1.5 text-xs font-bold text-cyan-300 shadow-sm">
                                <Stethoscope className="size-4 shrink-0 text-cyan-400" />
                            ...
                            <h1 className="text-4xl leading-[1.14] font-black tracking-tight text-white sm:text-5xl lg:text-[3.3rem]">
                            ...
                            <p className="mt-5 max-w-xl text-sm leading-relaxed font-normal text-slate-300 sm:text-[15px]">
                            ...
                            <div className="no-scrollbar mt-8 flex w-full flex-row flex-nowrap items-center gap-2.5 overflow-x-auto pb-1 sm:gap-3 sm:overflow-visible sm:pb-0">
                                ...
                                >
                                    <div className="flex h-[52px] items-center gap-2.5 rounded-2xl border border-slate-700 bg-slate-900/90 px-3.5 text-xs font-bold whitespace-nowrap text-white shadow-sm transition-all duration-200 hover:border-slate-600 hover:bg-slate-800 sm:px-4 sm:text-[13px]">
                                ...
                                >
                                    <div className="flex h-[52px] items-center gap-2.5 rounded-2xl border border-slate-700 bg-slate-900/90 px-3.5 text-xs font-bold whitespace-nowrap text-white shadow-sm transition-all duration-200 hover:border-slate-600 hover:bg-slate-800 sm:px-4 sm:text-[13px]">
                                        <PlaySquare className="size-4 shrink-0 text-cyan-400" />
                                ...
                                >
                                    <div className="flex h-[52px] items-center gap-2.5 rounded-2xl border border-slate-700 bg-slate-900/90 px-3.5 text-xs font-bold whitespace-nowrap text-white shadow-sm transition-all duration-200 hover:border-slate-600 hover:bg-slate-800 sm:px-4 sm:text-[13px]">
                                        <GraduationCap className="size-4 shrink-0 text-indigo-400" />
                                        <span>Mock Hall</span>
                                    </div>
                                </Link>
                            </div>
                    ...
                    <div className="mt-12 w-full rounded-2xl border border-slate-800/90 bg-gradient-to-r from-slate-900/95 via-[#0d1527] to-slate-900/95 p-5 shadow-2xl backdrop-blur-md sm:mt-14 sm:rounded-3xl sm:p-7">
                        <div className="grid grid-cols-1 items-center gap-6 divide-y divide-slate-800 sm:grid-cols-2 sm:divide-x sm:divide-y-0 sm:divide-slate-800 lg:grid-cols-4">
                            {/* Stat 1: 20,000+ */}
                            <div className="flex items-center gap-4 pt-4 first:px-0 first:pt-0 sm:px-4 sm:pt-0">
                                <div className="flex size-14 shrink-0 items-center justify-center rounded-2xl border border-emerald-500/20 bg-emerald-500/10 text-emerald-400">
                            ...
                            <div className="flex items-center gap-4 pt-4 sm:px-4 sm:pt-0">
                                ...
                                <div>
                                    <div className="font-mono text-2xl font-black tracking-tight text-cyan-400 sm:text-3xl">
                                        19 Subjects
                                    </div>
                                    <div className="mt-0.5 text-xs font-medium text-slate-400">
                            ...
                            <div className="flex items-center gap-4 pt-4 sm:px-4 sm:pt-0">
                                ...
                                <div>
                                    <div className="font-mono text-2xl font-black tracking-tight text-emerald-400 sm:text-3xl">
                                        Dual-Metric
                                    </div>
                                    <div className="mt-0.5 text-xs font-medium text-slate-400">
                            ...
                            {/* Stat 4: <100ms */}
                            <div className="flex items-center gap-4 pt-4 sm:px-4 sm:pt-0">
                                <div className="flex size-14 shrink-0 items-center justify-center rounded-2xl border border-purple-500/20 bg-purple-500/10 text-purple-400">
                                    <Zap className="size-6 fill-purple-400" />
                                </div>
                                <div>
                                    <div className="font-mono text-2xl font-black tracking-tight text-purple-400 sm:text-3xl">
                                        &lt;100ms
                                    </div>
                                    <div className="mt-0.5 text-xs font-medium text-slate-400">
            ...
            >
                <div className="mb-8 flex flex-col gap-2 text-center">
                    ...
                    <p className="mx-auto max-w-lg text-xs leading-relaxed text-slate-300 sm:text-sm">
                ...
                <div className="rounded-2xl border border-slate-800 bg-gradient-to-b from-slate-900/90 to-[#0d1322] p-6 shadow-xl backdrop-blur-sm transition-all duration-300 hover:border-cyan-500/40 sm:p-8">
                    {/* Top Stem Bar */}
                    <div className="flex items-center justify-between border-b border-slate-800/80 pb-3">
                        <div className="flex items-center gap-2">
                            <span className="rounded-lg border border-slate-700 bg-slate-800/80 px-2.5 py-1 font-mono text-xs font-bold text-cyan-400">
                                Q-MED-0401
                            </span>
                        ...
                        <span className="rounded-md border border-amber-500/30 bg-amber-500/10 px-2.5 py-0.5 text-[10px] font-bold tracking-wide text-amber-400 uppercase">
                            HIGH-YIELD EXAM VIGNETTE
                        </span>
                    </div>

                    {/* Vignette Stem */}
                    <p className="mt-4 text-sm leading-relaxed font-medium text-slate-100 sm:text-base">
                            ...
                            return (
                                <button
                                    ...
                                    className={`flex items-center gap-3 rounded-xl border p-3.5 text-left text-xs font-medium transition-all ${
                                        isSelected
                                            ? opt.correct
                                                ? 'border-emerald-500/80 bg-emerald-500/15 font-bold text-white shadow-sm shadow-emerald-500/10'
                                                : 'border-rose-500/80 bg-rose-500/15 font-bold text-white shadow-sm shadow-rose-500/10'
                    ...
                    <div className="mt-6 rounded-xl border border-slate-800 bg-slate-950/70 p-4 sm:p-5">
                        ...
                        <div className="mt-3.5 text-xs leading-relaxed text-slate-200 sm:text-sm">
            ...
            <section id="pathways" className="relative z-10 py-6">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="mb-10 flex flex-col gap-2 text-center">
                        ...
                        <p className="mx-auto max-w-md text-xs leading-relaxed text-slate-300 sm:text-sm">
                    ...
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                        {/* Nepal MECEE-PG */}
                        <div className="flex flex-col justify-between rounded-2xl border border-slate-800 bg-gradient-to-b from-slate-900/90 to-[#0d1322] p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-cyan-500/50 hover:shadow-xl">
                            <div>
                                <div className="flex items-center justify-between">
                                    <span className="rounded border border-sky-500/20 bg-sky-500/10 px-2 py-0.5 text-[10px] font-bold text-sky-400 uppercase">
                                        Nepal MD/MS
                                    </span>
                            ...
                            >
                                <Button
                                    variant="outline"
                                    size="sm"
                                    className="w-full border-slate-700 bg-slate-800/60 text-xs font-bold text-white hover:border-cyan-400 hover:bg-slate-800 hover:text-cyan-400"
                                >
                                    Practice MECEE-PG →
                                </Button>
                            </Link>
                        ...
                        {/* India INI-CET */}
                        <div className="flex flex-col justify-between rounded-2xl border-2 border-indigo-500/50 bg-gradient-to-b from-slate-900/90 to-[#0d1322] p-6 shadow-md transition-all duration-300 hover:-translate-y-1 hover:border-indigo-400 hover:shadow-xl">
                            <div>
                                <div className="flex items-center justify-between">
                                    <span className="rounded border border-indigo-500/30 bg-indigo-500/10 px-2 py-0.5 text-[10px] font-bold text-indigo-300 uppercase">
                                        India (AIIMS / PGI)
                                    </span>
                                    <span className="font-mono text-xs font-bold text-rose-400">
                                        -0.33 Mark
                            ...
                            >
                                <Button
                                    size="sm"
                                    className="w-full bg-gradient-to-r from-indigo-500 to-purple-600 text-xs font-bold text-white shadow-md shadow-indigo-500/20 hover:from-indigo-400 hover:to-purple-500"
                                >
                                    Practice INI-CET →
                                </Button>
                            </Link>
                        ...
                        {/* USA USMLE Step 1 */}
                        <div className="flex flex-col justify-between rounded-2xl border border-slate-800 bg-gradient-to-b from-slate-900/90 to-[#0d1322] p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-emerald-500/50 hover:shadow-lg">
                            <div>
                                <div className="flex items-center justify-between">
                                    <span className="rounded border border-emerald-500/20 bg-emerald-500/10 px-2 py-0.5 text-[10px] font-bold text-emerald-400 uppercase">
                                        USA Licensure
                                    </span>
                            ...
                            >
                                <Button
                                    variant="outline"
                                    size="sm"
                                    className="w-full border-slate-700 bg-slate-800/60 text-xs font-bold text-white hover:border-emerald-400 hover:bg-slate-800 hover:text-emerald-400"
                                >
                                    Practice Step 1 →
                                </Button>
                            </Link>
                        ...
                        {/* USA USMLE Step 2 CK */}
                        <div className="flex flex-col justify-between rounded-2xl border border-slate-800 bg-gradient-to-b from-slate-900/90 to-[#0d1322] p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-amber-500/50 hover:shadow-lg">
                            <div>
                                <div className="flex items-center justify-between">
                            ...
                            >
                                <Button
                                    variant="outline"
                                    size="sm"
                                    className="w-full border-slate-700 bg-slate-800/60 text-xs font-bold text-white hover:border-amber-400 hover:bg-slate-800 hover:text-amber-400"
                                >
                                    Practice Step 2 CK →
                                </Button>
                            </Link>
            ...
            <section id="features" className="relative z-10 py-6">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                        <div className="flex flex-col gap-3 rounded-2xl border border-slate-800 bg-gradient-to-b from-slate-900/90 to-[#0d1322] p-6 shadow-sm transition-all hover:border-cyan-500/40 hover:shadow-md">
                        ...
                        <div className="flex flex-col gap-3 rounded-2xl border border-slate-800 bg-gradient-to-b from-slate-900/90 to-[#0d1322] p-6 shadow-sm transition-all hover:border-emerald-500/40 hover:shadow-md">
                        ...
                        <div className="flex flex-col gap-3 rounded-2xl border border-slate-800 bg-gradient-to-b from-slate-900/90 to-[#0d1322] p-6 shadow-sm transition-all hover:border-indigo-500/40 hover:shadow-md">
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-2.5">
                        {[
                            ...
                            <span
                                key={sub}
                                className="cursor-default rounded-xl border border-slate-800 bg-slate-900/80 px-3.5 py-1.5 text-xs font-semibold text-slate-200 shadow-sm transition-all hover:scale-105 hover:border-cyan-400 hover:bg-slate-800 hover:text-cyan-300"
                            >
                                #{idx + 1} {sub}
                            </span>
                        ))}
            ...
            {/* Footer */}
            <footer className="relative z-10 mt-auto border-t border-slate-800/80 bg-[#050811] py-8 text-xs text-slate-400 backdrop-blur-sm">
