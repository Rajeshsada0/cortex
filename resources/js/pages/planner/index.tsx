        ...
        <div className="flex w-full flex-col gap-6 p-4 sm:p-6 lg:p-8">
            ...
            <div className="flex flex-col gap-2 border-b border-slate-200 pb-5 dark:border-slate-800">
                <div className="flex flex-wrap items-center gap-2.5">
                    ...
                    <span className="inline-flex items-center gap-1.5 rounded-full border border-slate-200 bg-slate-100 px-3 py-1 text-xs font-semibold text-slate-700 dark:border-slate-700 dark:bg-slate-800/80 dark:text-slate-300">
                ...
                <p className="max-w-2xl text-xs text-slate-600 dark:text-slate-300 sm:text-sm">
            ...
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
                {/* Countdown */}
                <div className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-4.5 shadow-sm transition-all hover:border-cyan-500/40 dark:border-slate-800 dark:bg-gradient-to-b dark:from-slate-900/90 dark:to-[#0d1322]">
                    <div className="flex items-center justify-between">
                        <span className="text-xs font-bold tracking-wider text-slate-500 uppercase dark:text-slate-400">
                            Countdown
                        </span>
                        <div className="flex size-7 items-center justify-center rounded-lg border border-cyan-500/20 bg-cyan-500/10 text-cyan-600 dark:text-cyan-400">
                            <Clock className="size-4" />
                        </div>
                    </div>
                    <div className="mt-2 flex items-baseline gap-1.5">
                        <span className="font-mono text-2xl font-black text-slate-900 sm:text-3xl dark:text-white">
                            {Number(plan.days_remaining).toFixed(2)}
                        </span>
                ...
                <div className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-4.5 shadow-sm transition-all hover:border-cyan-500/40 dark:border-slate-800 dark:bg-gradient-to-b dark:from-slate-900/90 dark:to-[#0d1322]">
                    ...
                    <div className="mt-2 flex items-baseline gap-1.5">
                        <span className="font-mono text-2xl font-black text-cyan-600 sm:text-3xl dark:text-cyan-400">
                            {plan.daily_study_hours}
                        </span>
                        <span className="text-xs font-semibold text-slate-500 dark:text-slate-400">hrs/day</span>
                    </div>
                    <span className="mt-1 block text-[11px] font-medium text-slate-500 dark:text-slate-400">
                ...
                {/* Required Pace */}
                <div className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-4.5 shadow-sm transition-all hover:border-emerald-500/40 dark:border-slate-800 dark:bg-gradient-to-b dark:from-slate-900/90 dark:to-[#0d1322]">
                    <div className="flex items-center justify-between">
                        <span className="text-xs font-bold tracking-wider text-slate-500 uppercase dark:text-slate-400">
                            Required Pace
                        </span>
                    ...
                    <div className="mt-2 flex items-baseline gap-1.5">
                        <span className="font-mono text-2xl font-black text-emerald-600 sm:text-3xl dark:text-emerald-400">
                            {plan.daily_mcq_target}
                        </span>
                        <span className="text-xs font-semibold text-slate-500 dark:text-slate-400">MCQs/day</span>
                    </div>
                    <span className="mt-1 block text-[11px] font-medium text-slate-500 dark:text-slate-400">
                ...
                {/* Remaining Pool */}
                <div className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-4.5 shadow-sm transition-all hover:border-purple-500/40 dark:border-slate-800 dark:bg-gradient-to-b dark:from-slate-900/90 dark:to-[#0d1322]">
                    <div className="flex items-center justify-between">
                        <span className="text-xs font-bold tracking-wider text-slate-500 uppercase dark:text-slate-400">
                            Remaining Pool
                        </span>
                        <div className="flex size-7 items-center justify-center rounded-lg border border-purple-500/20 bg-purple-500/10 text-purple-600 dark:text-purple-400">
                    ...
                    <div className="mt-2 flex items-baseline gap-1.5">
                        ...
                        <span className="text-xs font-semibold text-slate-500 dark:text-slate-400">/ {plan.total_questions}</span>
                    </div>
                    <span className="mt-1 block text-[11px] font-medium text-slate-500 dark:text-slate-400">
                        Questions to master
                    </span>
            ...
            {/* Recalculator Form */}
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-gradient-to-b dark:from-slate-900/90 dark:to-[#0d1322]">
                <div className="mb-5 flex items-center justify-between border-b border-slate-200 pb-3 dark:border-slate-800/80">
                    <div className="flex items-center gap-2">
                        <Calculator className="size-4 text-cyan-600 dark:text-cyan-400" />
                        <h3 className="text-sm font-bold tracking-wider text-slate-900 uppercase dark:text-white">
                            Mathematical Schedule Recalculator
                        </h3>
                    </div>
                    <span className="hidden text-xs text-slate-500 sm:inline-block dark:text-slate-400">
                ...
                >
                    ...
                    <div className="flex flex-col gap-2">
                        <label
                            ...
                            className="flex items-center gap-2 text-xs font-bold tracking-wide text-slate-700 dark:text-slate-300"
                        >
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="h-11 w-full cursor-pointer rounded-xl border border-slate-200 bg-slate-50 px-3.5 text-sm font-semibold text-slate-900 shadow-inner transition-all hover:border-slate-300 focus:border-cyan-500 focus:outline-none focus:ring-2 focus:ring-cyan-500/20 [color-scheme:light] dark:[color-scheme:dark] dark:border-slate-700 dark:bg-slate-900/90 dark:text-white dark:hover:border-slate-600 dark:focus:border-cyan-400"
                                required
                            />
                        </div>
                    ...
                    <div className="flex flex-col gap-2">
                        <div className="flex items-center justify-between">
                            ...
                            <span className="rounded-md border border-cyan-500/30 bg-cyan-500/10 px-2.5 py-0.5 font-mono text-xs font-bold text-cyan-700 dark:text-cyan-300">
                                {hours} hrs/day
                            </span>
                        </div>
                        <div className="flex flex-col gap-1.5 pt-1">
                            <input
                                ...
                                className="h-2.5 w-full cursor-pointer appearance-none rounded-lg bg-slate-200 accent-cyan-500 transition-all hover:bg-slate-300 dark:bg-slate-800 dark:accent-cyan-400 dark:hover:bg-slate-700"
                            />
            ...
            <div className="flex flex-col gap-4 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-gradient-to-b dark:from-slate-900/90 dark:to-[#0d1322]">
                <div className="flex flex-col gap-1 border-b border-slate-200 pb-3 sm:flex-row sm:items-center sm:justify-between dark:border-slate-800/80">
                    <div className="flex items-center gap-2">
                ...
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                    {[
                        ...
                        },
                        {
                            ...
                            badgeColor:
                                'border-indigo-500/30 bg-indigo-50 text-indigo-700 dark:bg-indigo-500/10 dark:text-indigo-300',
                        },
                        {
                            slot: '14:00 – 16:30',
                        ...
                        <div
                            key={idx}
                            className={`flex flex-col justify-between rounded-xl border border-slate-200 bg-slate-50/70 p-4 border-l-4 ${b.borderColor} transition-all hover:border-slate-300 dark:border-slate-800/80 dark:bg-slate-900/60 dark:hover:border-slate-700`}
                        >
